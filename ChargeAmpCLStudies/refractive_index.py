...
def confidence_plot(position, max_nr, min_nr, median_nr,range_pickle = "pickle_files/nr_range_pickle.pickle", bound_pickle = "pickle_files/full_data_nr_pickle.pickle", recalculate = True):
    if __name__ == "__main__":
        ...
        plt.savefig("plots/depth_scan_refractive_index_confidence_levels.png")
        plt.clf()
