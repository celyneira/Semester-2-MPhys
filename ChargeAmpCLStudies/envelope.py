...
SIC_DEPTH_SCAN = "200V/Zscan_SiC_x3_y4_-200V.mat"
...
def curve_fitting(lower_bounds, upper_bounds,data_file_name=CHARGE_DATA_FILE_NAME, mat_file = SIC_DEPTH_SCAN, fig_title = "plots/curve_fit.png", pickle_title=("pickle_files/wavelength_pickle.pickle")):
    if __name__ == "__main__":
        experiment_n_carriers, experimental_positions, errors = data_file_read(Z_LIMIT, filename = data_file_name, file = mat_file)
        ...
        picklefile = open(pickle_title,"wb")
        ...
        return popt[0], perr[1]

def confidence_plot(position, pickle_file = "pickle_files/envelope.pickle", recalculate = True):
