...
CHARGE_DATA_FILE_NAME = "200_x3y3.txt"
...
def confidence_plot(position, max_l, min_l, median_l,range_pickle = "pickle_files/l_range_pickle.pickle", bound_pickle = "pickle_files/full_data_l_pickle.pickle", recalculate = True):
    beta_data = np.genfromtxt(
            "beta_vals.txt", 
            delimiter=",", 
            dtype=[('coordinate', 'U10'), ('beta', 'f8'), ('error', 'f8')], 
